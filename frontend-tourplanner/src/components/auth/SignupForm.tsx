...
export const SignupForm: React.FC<SignupFormProps> = ({ onToggleMode }) => {
    ...
    return (
        <Card className="w-full max-w-md mx-auto mb-18">
            ...
            <CardContent className="space-y-4 px-4 sm:px-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-2">
                    ...
                    <Button type="submit" className="w-full bg-purple-500/90 text-white h-10 sm:h-11" disabled={loading}>
                ...
                <div className="text-center text-sm text-purple-500/90">
